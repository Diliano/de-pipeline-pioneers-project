...
from src.ingestion.utils import fetch_tables


@patch("src.ingestion.utils.get_last_ingestion_timestamp")
@patch("src.ingestion.utils.update_last_ingestion_timestamp")
@patch("src.ingestion.utils.connect_to_db")
